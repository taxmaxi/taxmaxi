...
const buildTransferDraft = ({
  ...
  return {
    ...
    assetId,
    assetRepresentationId: movement.asset.canonicalAssetRepresentationId,
  ...
  Effect.gen(function* () {
        ...
        movements: movements.map(
          (movement) =>
            new ActivityMovementFacts({
              ...
              assetRepresentationId: movement.asset.canonicalAssetRepresentationId,
              assetSymbol: movement.asset.assetSymbol,
              amount: movement.amount,
              fiatAmount: null,
              fiatCurrency: null,
    ...
    const buildOnchainContext = ({
      ...
      return {
        ...
        feeAssetRepresentationId: nativeAsset.canonicalAssetRepresentationId,
