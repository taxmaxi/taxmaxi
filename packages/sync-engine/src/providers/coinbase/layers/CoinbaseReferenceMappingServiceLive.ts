    ...
    Effect.gen(function* () {
      ...
      if (mapping.canonicalAssetCoinGeckoId === null) {
        return {
          ...
          reviewerNotes: null,
          sourceNotes:
            "Coinbase default asset mapping has no exact economic asset identity configured. Review required.",
        } satisfies ProviderAssetMappingDraft
      }
      ...
      return {
        ...
        mappingStatus: "pending_review",
        reviewerNotes: null,
        sourceNotes: `Coinbase default mapping targets CoinGecko asset ${mapping.canonicalAssetCoinGeckoId}, but no canonical assets row exists. Review required after adding or selecting a canonical asset.`,
      } satisfies ProviderAssetMappingDraft
    })
    ...
    Effect.gen(function* () {
      ...
      const canonicalAssetId = yield* resolveCanonicalAssetId({
        persistedMapping: {
          ...
          canonicalAssetRepresentationId: persistedMapping.canonicalAssetRepresentationId,
