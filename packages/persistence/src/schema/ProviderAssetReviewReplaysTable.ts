/**
 * ProviderAssetReviewReplaysTable - Durable provider-asset review replay links.
 *
...
/**
 * Binds an approved provider-asset decision and affected source to the exact
 * processing job that represents its replay request.
 */
