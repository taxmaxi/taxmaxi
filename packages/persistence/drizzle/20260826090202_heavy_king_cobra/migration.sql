...
CREATE TYPE "asset_resolution_outcome" AS ENUM('attach', 'create_standalone', 'excluded', 'pending', 'fail_closed');--> statement-breakpoint
...
CREATE TYPE "job_status" AS ENUM('pending', 'processing', 'completed', 'failed', 'credit_required');--> statement-breakpoint
...
CREATE TABLE "asset_resolution_decisions" (
	...
	CONSTRAINT "asset_resolution_decisions_approval_requires_target" CHECK ("outcome"::text not in ('attach', 'create_standalone') or ("asset_id" is not null and "asset_representation_id" is not null))
);
--> statement-breakpoint
...
CREATE TABLE "assets" (
	...
	"logo_url" text,
	"type" "asset_type" DEFAULT 'fungible'::"asset_type" NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "disposal_matches" (
	...
	"matched_amount" numeric(355,255) NOT NULL,
...
CREATE TABLE "fifo_lots" (
	...
	"original_amount" numeric(355,255) NOT NULL,
	"remaining_amount" numeric(355,255) NOT NULL,
	"cost_basis_per_token" numeric(355,18) NOT NULL,
...
CREATE TABLE "inventory_movements" (
	...
	"amount" numeric(355,255) NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "processing_jobs" (
	...
	"additional_credits_required" integer,
...
CREATE TABLE "provider_asset_mappings" (
	...
	"mapping_status" "provider_asset_mapping_status" DEFAULT 'pending_review'::"provider_asset_mapping_status" NOT NULL,
	"reviewer_notes" text,
	"source_notes" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	...
	CONSTRAINT "provider_asset_mappings_representation_requires_asset" CHECK ("asset_representation_id" is null or "canonical_asset_id" is not null)
);
--> statement-breakpoint
...
CREATE TABLE "provider_assets" (
	...
	CONSTRAINT "provider_assets_evidence_revision_positive" CHECK ("evidence_revision" > 0)
);
--> statement-breakpoint
...
CREATE TABLE "provider_transfers" (
	...
	"processing_mode" "provider_transfer_processing_mode" NOT NULL,
	...
	"network_name" text,
	"network_hash" text,
	"observed_blockchain_id" uuid,
	"observed_representation_type" "asset_representation_type",
	"observed_contract_address" text,
	"observed_mint_address" text,
	...
	CONSTRAINT "provider_transfers_observed_representation_complete" CHECK (coalesce((
	...
	CONSTRAINT "provider_transfers_observed_decimals_non_negative" CHECK ("observed_decimals" is null or "observed_decimals" >= 0),
	CONSTRAINT "provider_transfers_non_observation_has_no_identity" CHECK ("processing_mode" not in ('accounting_only', 'stale') or (
        "observed_representation_type" is null
        and "observed_blockchain_id" is null
        and "observed_contract_address" is null
        and "observed_mint_address" is null
...
CREATE UNIQUE INDEX "asset_representations_contract_unique_idx" ON "asset_representations" ("blockchain_id","contract_address") WHERE "contract_address" is not null;--> statement-breakpoint
...
CREATE UNIQUE INDEX "wallet_name_cache_namespace_name_idx" ON "wallet_name_cache" ("namespace","name");--> statement-breakpoint
...
ALTER TABLE "transfers" ADD CONSTRAINT "transfers_representation_matches_asset_fk" FOREIGN KEY ("asset_id","asset_representation_id") REFERENCES "asset_representations"("asset_id","id");