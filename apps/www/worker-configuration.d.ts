/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bbf28427ac36a963de76bf49df69b093)
// Runtime types generated with workerd@1.20260701.1 2025-09-02 enable_ctx_exports,nodejs_compat
interface __BaseEnv_Env {
	COOKIE_DOMAIN: ".taxmaxi.com";
	PAYLOAD_API_URL: "https://cms.taxmaxi.com";
	VITE_POSTHOG_KEY: string;
	VITE_POSTHOG_HOST: string;
	VITE_TAXMAXI_API_BASE_URL: string;
	TAXMAXI_API_BASE_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COOKIE_DOMAIN" | "PAYLOAD_API_URL" | "VITE_POSTHOG_KEY" | "VITE_POSTHOG_HOST" | "VITE_TAXMAXI_API_BASE_URL" | "TAXMAXI_API_BASE_URL">> {}
}
