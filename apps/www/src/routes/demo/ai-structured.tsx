...
function RecipeCard({ recipe }: { recipe: Recipe }) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h3 className="text-2xl font-bold text-[var(--sea-ink)] mb-2">{recipe.name}</h3>
      ...
      {/* Ingredients */}
      <div>
        <h4 className="text-lg font-semibold text-[var(--sea-ink)] mb-3">Ingredients</h4>
      ...
      {/* Instructions */}
      <div>
        <h4 className="text-lg font-semibold text-[var(--sea-ink)] mb-3">Instructions</h4>
      ...
      {recipe.tips && recipe.tips.length > 0 && (
        <div>
          <h4 className="text-lg font-semibold text-[var(--sea-ink)] mb-3">Tips</h4>
