...
import { getTaxLawArticle } from "#/integrations/payload/functions"
import { createCmsPageHead } from "#/integrations/payload/head"
import { getLocale } from "#/paraglide/runtime"

export const Route = createFileRoute("/tax-law/$slug")({
  staleTime: CMS_ROUTE_STALE_TIME_MS,
  preloadStaleTime: CMS_ROUTE_STALE_TIME_MS,
  loader: async ({ params }) => {
    const page = await getTaxLawArticle({
  ...
  component: TaxLawArticleRoute,
})

function TaxLawArticleRoute() {
