...
The bar comes from the _Animations on the Web_ course ([animations.dev](https://animations.dev/)).
...
- A spinner or loader that spins slowly — speed here directly changes how fast the app _feels_, at identical load times.
