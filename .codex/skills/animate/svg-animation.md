...
Recipes for animating SVG (line-drawing, rotation, path morphing, ambient motion). Load from [SKILL.md](SKILL.md) when animating vector art. All values from the _Animations on the Web_ course.
...
} /* clock center of a 100×100 viewBox */
```
